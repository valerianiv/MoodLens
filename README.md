...
- [Технические особенности](#технические-особенности)
  ...
  - [Выбор датасета](#выбор-датасета)
- [Установка и запуск](#установка-и-запуск)
- [Примеры работы приложения](#примеры-работы-приложения)
- [Рекомендации и перспективы](#рекомендации-и-перспективы)
------------------
...
---------------------------
<a id="технические-особенности"></a>
...
<a id="примеры-работы-приложения"></a>
...
<a id="рекомендации-и-перспективы"></a>
### Рекомендации и перспективы
- Интеграция модели Segment Anything Model (SAM) для повышение точности выделения областей лица и учета контекстного окружения.
- Расширение функционала до работы с видео (в том числе в реальном времени).
- Реализация поддержки работы на мобильных платформах.
- Интеграция для видеоконференций (Zoom, Google Meet).
- Расширение датасета для классов с меньшим количеством изображений.
